        ...
        <ul class="space-y-4 flex-1">
                ...
                <ul x-show="open" x-transition class="space-y-1 ml-4 mt-2">
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Gestión de Usuarios</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Gestión de roles y permiso</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Configuración de accesos al sistema</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="mt-4" x-data="sidebarDropdown('clientes')">
                ...
                <ul x-show="open" x-transition class="space-y-1 ml-4 mt-2">
                     <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Gestión de Empresas</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Cotizaciones</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="mt-4" x-data="sidebarDropdown('solicitudes')">
                ...
                <ul x-show="open" x-transition class="space-y-1 ml-4 mt-2">
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Solicitudes</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Ordenes de Servicio</span>
                        </a>
                    </li>
                      <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Empresas</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="mt-4" x-data="sidebarDropdown('proyectos')">
                ...
                <ul x-show="open" x-transition class="space-y-1 ml-4 mt-2">
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Gestion de proyectos</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="mt-4" x-data="sidebarDropdown('calendario')">
                ...
                <ul x-show="open" x-transition class="space-y-1 ml-4 mt-2">
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Agencias</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Calendario</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="mt-4" x-data="sidebarDropdown('facturacion')">
                ...
                <ul x-show="open" x-transition class="space-y-1 ml-4 mt-2">
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Facturas</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">CAI</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="mt-4" x-data="sidebarDropdown('reportes')">
                ...
                <ul x-show="open" x-transition class="space-y-1 ml-4 mt-2">
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Gestion de Reportes</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="mt-4" x-data="sidebarDropdown('inventario')">
                ...
                <ul x-show="open" x-transition class="space-y-1 ml-4 mt-2">
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Productos</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Kardex</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="mt-4" x-data="sidebarDropdown('administracion')">
                ...
                <ul x-show="open" x-transition class="space-y-1 ml-4 mt-2">
                    ...
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Cambio de contraseña</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Bitácora</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-2 py-2 px-4 rounded hover:bg-gray-800 hover:text-blue-400 transition-colors">
                            <span class="text-sm nunito-regular">Gestion de Base de Datos</span>
                        </a>
                    </li>
                </ul>
            </li>
