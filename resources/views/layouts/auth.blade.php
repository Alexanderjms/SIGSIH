                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-8">
                        ...
                        <div class="text-center mb-8">
                            ...
                            <p class="text-gray-600 mt-2">
                                <span
                                    x-text="isLogin ? 'Please sign in to continue' : 'Get started with your account'"></span>
                            </p>
                        </div>
                        ...
                        <form @submit.prevent="handleSubmit">
                            ...
                            <div class="mb-6">
                                ...
                                <p x-show="email && !validateEmail(email)" class="mt-2 text-sm text-red-600">Please
                            ...
                            <div x-show="!isLogin" class="mb-6 transition-all duration-300 ease-out">
                                ...
                                <p x-show="confirmPassword && !validateConfirmPassword()"
                                    class="mt-2 text-sm text-red-600">Passwords do not match</p>
                            </div>
            ...
            <div class="hidden lg:block lg:w-1/2 bg-cover bg-center"
                ...
                <div class="h-full bg-black bg-opacity-50 flex items-center justify-center">
                    <div class="text-center text-white px-12">
                        ...
                        <p class="text-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis, expedita.
                        </p>
                    </div>
                </div>
            </div>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('authPage', () => ({
            ...
            handleSubmit() {
                ...
                setTimeout(() => {
                    this.loading = false;
                    alert(this.isLogin ? 'Logged in successfully!' :
