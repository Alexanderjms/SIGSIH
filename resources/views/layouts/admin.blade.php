...
<body class="bg-gray-900 min-h-screen flex flex-col" x-data="{ sidebarOpen: true }">
    <div class="flex h-screen min-h-0">
        ...
        <main class="flex-1 p-6 overflow-y-auto h-screen bg-white text-gray-900 transition-opacity duration-300" :class="{ 'opacity-25': $store.navigation.isTransitioning }">
