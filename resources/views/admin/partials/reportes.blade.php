    ...
    <div class="w-full">
        <ul class="flex border-b nunito-bold">
            <li @click="tab='reportes'"
                :class="tab==='reportes' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-600 hover:text-blue-500 cursor-pointer'"
                class="mr-6 pb-2">Reportes</li>
            <li @click="tab='servicios'"
                :class="tab==='servicios' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-600 hover:text-blue-500 cursor-pointer'"
                class="mr-6 pb-2">Servicio Realizado</li>
        ...
        <x-admin.form-modal modalName="isModalOpen" title="Nuevo Reporte" submitLabel="Guardar Reporte"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="accion_realizada" class="block text-sm font-medium text-gray-700">Acción
                        Realizada</label>
                    <input type="text" id="accion_realizada" name="accion_realizada"
                        class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
                </div>
                <div>
                    <label for="orden_servicio" class="block text-sm font-medium text-gray-700">Orden de
                        Servicio</label>
        ...
        <x-admin.form-modal modalName="isServicioModalOpen" title="Nuevo Servicio Realizado"
            submitLabel="Guardar Servicio" maxWidth="max-w-2xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
