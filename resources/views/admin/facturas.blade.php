...
<div x-data="{ 
    ...
    <div class="mb-6 border-b border-gray-200">
        <ul class="flex border-b nunito-bold">
            <li @click="tab='facturas'" :class="tab==='facturas' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-600 hover:text-blue-500 cursor-pointer'" class="mr-6 pb-2">Facturas</li>
            <li @click="tab='detalle'" :class="tab==='detalle' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-600 hover:text-blue-500 cursor-pointer'" class="mr-6 pb-2">Detalle de Factura</li>
            <li @click="tab='servicio'" :class="tab==='servicio' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-600 hover:text-blue-500 cursor-pointer'" class="mr-6 pb-2">Servicios</li>
            <li @click="tab='estado_factura'" :class="tab==='estado_factura' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-600 hover:text-blue-500 cursor-pointer'" class="pb-2">Estado de Factura</li>
        </ul>
    </div>
        ...
        <x-admin.tabla-crud>
            ...
            <x-slot name="filtros">
                <div class="flex gap-2">
                    <input type="text" placeholder="Buscar factura..." class="border rounded px-3 py-2 text-sm w-full sm:w-48" />
                    ...
                    <button class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg nunito-bold transition whitespace-nowrap flex items-center gap-2">
            ...
            <x-slot name="boton">
                <button @click="isFacturaModalOpen = true" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg nunito-bold transition whitespace-nowrap">Nueva Factura</button>
            </x-slot>
                    ...
                    <tbody>
                        <tr class="border-b nunito-regular">
                            ...
                            <td class="py-2 px-4 flex gap-2">
                                <a href="{{ route('admin.formato-factura') }}" target="_blank" class="inline-flex items-center justify-center text-xs w-24 h-9 rounded bg-emerald-500 text-white hover:bg-emerald-600 duration-300 mr-2">
                                    <i class="fas fa-eye mr-1"></i> Ver detalles
                                </a>
                                <a href="#" @click.prevent="isEditFacturaModalOpen = true; facturaToEdit = {id: 1, numero: '0001', fecha: '2025-07-30', oc: 'OC-12345', subtotal: 5000, total: 5500, total_letras: 'Cinco mil quinientos lempiras', estado_factura: 'Pagada', cai: 'CAI-987654321', cliente: 'BAC credomatic'}" class="inline-flex items-center justify-center text-blue-500 hover:text-blue-700">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="#" @click.prevent="isDeleteFacturaModalOpen = true; facturaToDelete = {id: 1}" class="inline-flex items-center justify-center text-red-500 hover:text-red-700">
                        ...
                        <tr class="border-b nunito-regular">
                            ...
                            <td class="py-2 px-4 flex gap-2">
                                ...
                                <a href="#" @click.prevent="isEditFacturaModalOpen = true; facturaToEdit = {id: 2, numero: '0002', fecha: '2025-07-31', oc: 'OC-54321', subtotal: 6000, total: 6500, total_letras: 'Seis mil quinientos lempiras', estado_factura: 'Pendiente', cai: 'CAI-123456789', cliente: 'Bancafe'}" class="inline-flex items-center justify-center text-blue-500 hover:text-blue-700">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="#" @click.prevent="isDeleteFacturaModalOpen = true; facturaToDelete = {id: 2}" class="inline-flex items-center justify-center text-red-500 hover:text-red-700">
                                    <i class="fas fa-trash"></i>
                                </a>
                            </td>
                        </tr>
    ...
    <x-admin.edit-modal 
        modalName="isEditFacturaModalOpen" 
        title="Editar Factura" 
        itemToEdit="facturaToEdit"
        maxWidth="max-w-2xl">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
    ...
    <x-admin.confirmation-modal
        modalName="isDeleteFacturaModalOpen"
        itemToDelete="facturaToDelete"
    ...
    <x-admin.form-modal 
        modalName="isDetalleModalOpen" 
        title="Nuevo Detalle Factura" 
    ...
    <x-admin.edit-modal 
        modalName="isEditDetalleModalOpen" 
        title="Editar Detalle Factura" 
        itemToEdit="detalleToEdit"
        maxWidth="max-w-xl">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
    ...
    <x-admin.confirmation-modal
        modalName="isDeleteDetalleModalOpen"
        itemToDelete="detalleToDelete"
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        <tr class="border-b nunito-regular">
                            ...
                            <td class="py-2 px-4 flex gap-2">
                                <a href="#" @click.prevent="isEditServicioModalOpen = true; servicioToEdit = {id: 'SVC-01', nombre: 'Consultoría', tarifa: 1500}" class="text-blue-500 hover:text-blue-700"><i class="fas fa-edit"></i></a>
                                <a href="#" @click.prevent="isDeleteServicioModalOpen = true; servicioToDelete = {id: 'SVC-01'}" class="text-red-500 hover:text-red-700"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <x-admin.form-modal 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="id_servicio_nuevo" name="id_servicio_nuevo" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
            <div>
                <label for="nombre_servicio" class="block text-sm font-medium text-gray-700">Nombre Servicio</label>
                <input type="text" id="nombre_servicio" name="nombre_servicio" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
            <div>
                <label for="tarifa" class="block text-sm font-medium text-gray-700">Tarifa</label>
                <input type="number" id="tarifa" name="tarifa" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
        </div>
    </x-admin.form-modal>
    ...
    <x-admin.edit-modal 
        modalName="isEditServicioModalOpen" 
        title="Editar Servicio" 
        itemToEdit="servicioToEdit"
        maxWidth="max-w-md">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label for="edit_id_servicio" class="block text-sm font-medium text-gray-700">ID</label>
                <input type="text" id="edit_id_servicio" name="edit_id_servicio" :value="servicioToEdit.id" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
            <div>
                <label for="edit_nombre_servicio" class="block text-sm font-medium text-gray-700">Nombre Servicio</label>
                <input type="text" id="edit_nombre_servicio" name="edit_nombre_servicio" :value="servicioToEdit.nombre" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
            <div>
                <label for="edit_tarifa" class="block text-sm font-medium text-gray-700">Tarifa</label>
                <input type="number" id="edit_tarifa" name="edit_tarifa" :value="servicioToEdit.tarifa" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
        </div>
    </x-admin.edit-modal>
    ...
    <x-admin.confirmation-modal
        modalName="isDeleteServicioModalOpen"
        itemToDelete="servicioToDelete"
    ...
    <div x-show="tab==='detalle'" class="overflow-x-auto">
        <x-admin.tabla-crud>
            ...
            <x-slot name="filtros">
                <input type="text" placeholder="Buscar detalle..." class="border rounded px-3 py-2 text-sm w-full sm:w-48" />
            </x-slot>
            <x-slot name="boton">
                <button @click="isDetalleModalOpen = true" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg nunito-bold transition whitespace-nowrap">Nuevo Detalle</button>
            </x-slot>
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm">
                    <thead class="bg-gray-100 nunito-bold">
                    ...
                    <tbody>
                        <tr class="border-b nunito-regular">
                            ...
                            <td class="py-2 px-4 flex gap-2">
                                <a href="#" @click.prevent="isEditDetalleModalOpen = true; detalleToEdit = {id_detalle: 1, id_factura: '0001', id_servicio: 'SVC-01', fecha_servicio: '2025-07-26', horas: 8, descuento: 0}" class="text-blue-500 hover:text-blue-700"><i class="fas fa-edit"></i></a>
                                <a href="#" @click.prevent="isDeleteDetalleModalOpen = true; detalleToDelete = {id_detalle: 1}" class="text-red-500 hover:text-red-700"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        <tr class="border-b nunito-regular">
                            ...
                            <td class="py-2 px-4 flex gap-2">
                                <a href="#" @click.prevent="isEditEstadoFacturaModalOpen = true; estadoFacturaToEdit = {id: 1, nombre: 'Pagada', descripcion: 'Factura completamente pagada'}" class="text-blue-500 hover:text-blue-700"><i class="fas fa-edit"></i></a>
                                <a href="#" @click.prevent="isDeleteEstadoFacturaModalOpen = true; estadoFacturaToDelete = {id: 1}" class="text-red-500 hover:text-red-700"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <x-admin.form-modal 
        modalName="isEstadoFacturaModalOpen" 
        title="Nuevo Estado Factura" 
        ...
        <div class="grid grid-cols-1 gap-4">
            <div>
                ...
                <input type="text" id="nombre_estado_factura" name="nombre_estado_factura" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
            <div>
                <label for="descripcion_estado_factura" class="block text-sm font-medium text-gray-700">Descripción</label>
                <input type="text" id="descripcion_estado_factura" name="descripcion_estado_factura" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
        </div>
    </x-admin.form-modal>
    ...
    <x-admin.edit-modal 
        modalName="isEditEstadoFacturaModalOpen" 
        title="Editar Estado Factura" 
        itemToEdit="estadoFacturaToEdit"
        maxWidth="max-w-md">
        <div class="grid grid-cols-1 gap-4">
            <div>
                <label for="edit_nombre_estado_factura" class="block text-sm font-medium text-gray-700">Nombre Estado</label>
                <input type="text" id="edit_nombre_estado_factura" name="edit_nombre_estado_factura" :value="estadoFacturaToEdit.nombre" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
            <div>
                <label for="edit_descripcion_estado_factura" class="block text-sm font-medium text-gray-700">Descripción</label>
                <input type="text" id="edit_descripcion_estado_factura" name="edit_descripcion_estado_factura" :value="estadoFacturaToEdit.descripcion" class="mt-1 block w-full rounded-md border-gray-500 shadow-sm border focus:border-gray-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 nunito-regular px-2">
            </div>
        </div>
    </x-admin.edit-modal>
    ...
    <x-admin.confirmation-modal
        modalName="isDeleteEstadoFacturaModalOpen"
        itemToDelete="estadoFacturaToDelete"
