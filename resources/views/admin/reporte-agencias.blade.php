                ...
                <table class="min-w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border border-gray-300 py-2 px-3 nunito-regular">Tegucigalpa</td>
                            <td class="border border-gray-300 py-2 px-3 nunito-regular">Activa</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border border-gray-300 py-2 px-3 nunito-regular">San Pedro Sula</td>
                            <td class="border border-gray-300 py-2 px-3 nunito-regular">Activa</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border border-gray-300 py-2 px-3 nunito-regular">Choluteca</td>
                            <td class="border border-gray-300 py-2 px-3 nunito-regular">Inactiva</td>
                        </tr>
                    </tbody>
                </table>
            </div>
