...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <a href="#" class="bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg p-4 flex flex-col items-center transition">
            <i class="fas fa-ticket-alt fa-lg mb-2"></i>
            <span>Nuevo ticket</span>
        </a>
        <a href="#" class="bg-purple-500 hover:bg-purple-600 text-white rounded-lg p-4 flex flex-col items-center transition">
